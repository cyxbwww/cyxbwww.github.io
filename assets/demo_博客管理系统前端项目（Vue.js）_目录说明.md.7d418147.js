import{_ as s,c as n,o as a,d as l}from"./app.b79b95b0.js";const m=JSON.parse('{"title":"目录说明","description":"","frontmatter":{},"headers":[],"relativePath":"demo/博客管理系统前端项目（Vue.js）/目录说明.md","lastUpdated":1675695985000}'),p={name:"demo/博客管理系统前端项目（Vue.js）/目录说明.md"},e=l(`<h1 id="目录说明" tabindex="-1">目录说明 <a class="header-anchor" href="#目录说明" aria-hidden="true">#</a></h1><div class="language-text"><button title="Copy Code" class="copy"></button><span class="lang">text</span><pre class="shiki material-palenight"><code><span class="line"><span style="color:#A6ACCD;">cyxbwww-admin</span></span>
